...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "cv",
          description: "My CV is available in the PDF on the right, which you can also download for more details.",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "projects-automated-filming-device",
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-bulnabi-software-club",
          title: 'Bulnabi Software Club',
          description: "Hands-on activities in drone and robotics software",
          section: "Projects",handler: () => {
              window.location.href = "/projects/5_project/";
            },},{id: "projects-optimal-beam-design-project",
          title: 'Optimal Beam Design Project',
          description: "Term project in Materials and Manufacturing Processes - CFRP-Woodrock composite beam design and testing",
          section: "Projects",handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%73%65%75%6E%67%68%75%6E@%67.%75%63%6C%61.%65%64%75", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/alvin0808", "_blank");
        },
      },{
        id: 'social-instagram',
        title: 'Instagram',
        section: 'Socials',
        handler: () => {
          window.open("https://instagram.com/oshnhsn", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=gw7kO4IAAAAJ", "_blank");
        },
      },{
      id: 'light-theme',
